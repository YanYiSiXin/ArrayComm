...
class BeamConfId
{
  public:
    ...
    BeamConfId(BeamId firstBeam, BeamId secondBeam, BeamId thirdBeam, BeamId fourthBeam);
 ...
 //pengpeng:
    BeamId GetThirdBeam() const;
    BeamId GetFourthBeam() const;
  ...
  private:
    ...
    //pengpeng: 4x4 mimo scheme
    BeamId m_thirdBeam = BeamId::GetEmptyBeamId();  //!< the first beam ID
    BeamId m_fourthBeam = BeamId::GetEmptyBeamId(); //!< the second beam ID
};
