...
BeamConfId::BeamConfId()
{
    m_firstBeam = BeamId::GetEmptyBeamId();
    m_secondBeam = BeamId::GetEmptyBeamId();
    m_thirdBeam = BeamId::GetEmptyBeamId();
    m_fourthBeam = BeamId::GetEmptyBeamId();
}
...
BeamConfId::BeamConfId(BeamId firstBeam, BeamId secondBeam, BeamId thirdBeam, BeamId fourthBeam)
{
    m_firstBeam = firstBeam;
    m_secondBeam = secondBeam;
    m_thirdBeam = thirdBeam;
    m_fourthBeam = fourthBeam;
...
//pengpeng: 4x4 mimo scheme
BeamId
BeamConfId::GetThirdBeam() const
{
    return m_thirdBeam;
}

BeamId
BeamConfId::GetFourthBeam() const
{
    return m_fourthBeam;
}
