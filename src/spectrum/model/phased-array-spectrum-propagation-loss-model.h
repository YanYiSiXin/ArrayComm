...
class PhasedArraySpectrumPropagationLossModel : public Object
{
  ...
  /**
   * This method is to be called to calculate the complex channel between the two port pairs
   *
   ...
   * @param bPhasedArrayModel the instance of the phased antenna array of the receiver
   *
   * @return the complex channel between two port pairs
   */
  std::vector<std::complex<double>> CalcRxComplexChannel (Ptr<SpectrumValue> txPsd,
                                                          Ptr<const MobilityModel> a,
                                                          Ptr<const MobilityModel> b,
                                                          Ptr<const PhasedArrayModel> aPhasedArrayModel,
                                                          Ptr<const PhasedArrayModel> bPhasedArrayModel) const;
   ...
   * @return the complex channel between two port pairs
   */
  virtual std::vector<std::complex<double>> DoCalcRxComplexChannel (Ptr<SpectrumValue> txPsd, 
                                                                    Ptr<const MobilityModel> a, 
                                                                    Ptr<const MobilityModel> b, 
                                                                    Ptr<const PhasedArrayModel> aPhasedArrayModel, 
                                                                    Ptr<const PhasedArrayModel> bPhasedArrayModel) const = 0;
