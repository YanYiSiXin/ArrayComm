...
ThreeGppPropagationLossModel::GetTypeId()
{
    static TypeId tid =
        TypeId("ns3::ThreeGppPropagationLossModel")
            ...
            .AddTraceSource ("shadowing",
                             "Trace gnb-ue pair shadowing",
                             MakeTraceSourceAccessor (&ThreeGppPropagationLossModel::m_shadowingTrace),
                             "ns3::ThreeGppPropagationLossModel::ShadowingTracedCallback");
    return tid;
}
                                           ...
                                           ChannelCondition::LosConditionValue cond) const
{
    ...
    // update the entry in the map
    m_shadowingTrace(a, b, shadowingValue);
