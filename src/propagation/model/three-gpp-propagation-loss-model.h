...
class ThreeGppPropagationLossModel : public PropagationLossModel
{
  ...
  protected:
    ...
    typedef void(* ShadowingTracedCallback)(Ptr<MobilityModel>, Ptr<MobilityModel>, double );
    TracedCallback<Ptr<MobilityModel>, Ptr<MobilityModel>, double > m_shadowingTrace;
};
